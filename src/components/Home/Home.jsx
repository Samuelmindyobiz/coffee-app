...
import HeroImg from '../../assets/cup2.webp'
            ...
            <div className="container pb-8 sm:pb-0">
                <div className="grid grid-cols-1 sm:grid-cols-2">
                    ...
                    <div className='order-2 sm:order-1 flex flex-col justify-center gap-6'>
                        <h1 className='text-5xl sm:text-6xl lg:text-7xl font-bold'>we serve the most Organic <span className='text-primary font-cursive'>Coffee</span> in the city</h1>
                        <div>
